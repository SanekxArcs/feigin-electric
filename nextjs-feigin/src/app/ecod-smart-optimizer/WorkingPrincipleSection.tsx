  ...
  return (
    <>
      <div className="container mx-auto px-4">
        <section className="py-12 lg:py-20 px-4 md:px-8 lg:px-16 bg-white rounded-lg shadow-lg mb-12">
        ...
        <section className="container mx-auto py-12 lg:py-20 px-4 md:px-8 lg:px-16 bg-white rounded-lg shadow-lg">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <p className="text-gray-700 mt-6 text-center lg:text-left">
            ...
            Oznacza to, że przy tym napięciu klimatyzator optymalnie
            wykorzystuje energię elektryczną, osiągając prawie 100% sprawności.
          </p>
        </section>
      </div>
    </>

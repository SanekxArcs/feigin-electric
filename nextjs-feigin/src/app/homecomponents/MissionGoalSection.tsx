    ...
    <>
      <section className="py-10 md:py-20 relative overflow-hidden container mx-auto px-6 text-center grid place-content-center">
        <h2 className="text-4xl font-bold mb-12 text-center">
          <HighlightedText title={plLang.mission.title}  />
        </h2>
        <p className="text-lg md:text-xl leading-relaxed text-center text-balance md:w-2/3 mx-auto select-none">
          {plLang.mission.description}
        </p>
      </section>
      <section className="py-10 md:py-20 relative overflow-hidden container mx-auto px-6 text-center grid place-content-center">
        <h3 className="text-3xl font-semibold mb-12 text-fred-600">
          <HighlightedText title={plLang.goal.title} />
        </h3>
        <ul className="mb-6 space-y-4 text-lg leading-relaxed list-inside text-left select-none">

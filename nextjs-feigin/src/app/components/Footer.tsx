...
import Link from "next/link"; // Import icons

const Footer = () => {
  const currentYear = new Date().getFullYear();

  return (
    <footer className="bg-primary py-8 rounded-t-3xl mx-1 shadow-accent-foreground relative">
      <div className="absolute bottom-4 left-1/2 md:left-6 -translate-x-1/2 md:-translate-x-0 transform  flex space-x-4">
        <Link
          href="https://www.linkedin.com/company/feiginelectric"

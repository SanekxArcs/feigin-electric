            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-6 shadow-md rounded-lg">
                ...
                <p className="mt-4 text-gray-600">
                  Reduce energy bills by up to 14% with the Ecod Smart
                  Optimizer’s optimized voltage control system.
                </p>
              </div>
              ...
              <div className="bg-white p-6 shadow-md rounded-lg">
                ...
                <p className="mt-4 text-gray-600">
                  The Ecod Smart Optimizer features a smaller, lighter design
                ...
                <ul className="mt-8 space-y-6">
                  <li>
                    ...
                    <p className="mt-2 text-gray-600">
                      ...
                      in an AC system. It is used to develop magnetic fields in
                  ...
                  <li>
                    ...
                    <p className="mt-2 text-gray-600">
                      Multiples of the supply frequency, e.g., the fifth
                      harmonic would be 250 Hz when the supply frequency is 50
                      Hz. They are caused by electronic loads such as variable
                      speed drives and UPS systems.
                    </p>
                  </li>
                  <li>
                    <h3 className="text-xl font-semibold">Network Imbalance</h3>
                    <p className="mt-2 text-gray-600">
                      Differences in voltage between lines, caused by
                      single-phase loads, phase-to-phase loads, and unbalanced
                      three-phase loads, such as welding equipment.
                    </p>
                  </li>
                  <li>
                    <h3 className="text-xl font-semibold">Surges</h3>
                    <p className="mt-2 text-gray-600">
                      A sudden change in the sine wave that occurs in both
                      voltage and current waveforms. They are caused by
                      switching devices and the starting and stopping of
                  ...
                  <li>
                    ...
                    <p className="mt-2 text-gray-600">
                      ...
                      voltage is higher or lower than nominal for a short
                      period. They are caused by network faults, switching of
                      capacitive loads, and excessive loads.
                    </p>
                  </li>
                  <li>
              ...
              <div className="md:flex md:items-center">
                <div className="md:w-1/2">
                  ...
                  <p className="mt-4 text-gray-600">
                    ...
                    direction of current in the coil of each transformer (one
                    per phase), monitoring and balancing the network parameters.
                    This is aimed at maintaining maximum efficiency with minimal
              ...
              <div className="md:flex md:items-center">
                <div className="md:w-1/2">
                  ...
                  <p className="mt-4 text-gray-600">
                    ...
                    efficiency of the air conditioner at a voltage of 210 to 220
                    V is close to 100%. This means that at this voltage, the air
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border-b p-4">
                      Reduces losses by more than six times, improving
                      efficiency.
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="border-b p-4">
                      Focuses on voltage optimization but is not very effective
                      at minimizing losses.
                    </td>
                    <td className="border-b p-4">
                      Optimizes energy (kWh), peak power (kW), and reactive
                      power (kVAr).
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="border-b p-4">
                      Compact design for easy integration in various
                      environments.
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="border-b p-4">
                      Potential savings of around 4%, inconsistent, and often
                      used internally.
                    </td>
                    <td className="border-b p-4">
              ...
              <div className="md:w-1/2">
                <ul className="list-disc list-inside space-y-4 text-gray-600">
                  <li>
                    ...
                    Monitor your energy usage in real time, down to each device
                    or equipment.
                  </li>
                  <li>
